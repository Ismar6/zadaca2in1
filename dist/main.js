     ...
     */ !(function (t, n) {
      ...
      (C.fn = C.prototype = {
        ...
        pushStack: function (e) {
          let t = C.merge(this.constructor(), e);
      ...
      C.fn.extend({
        has: function (e) {
          ...
          return this.filter(function () {
            for (let e = 0; e < n; e++) if (C.contains(this, t[e])) return !0;
          });
        },
      ...
      let He = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
      ...
      let Ye = ["Webkit", "Moz", "ms"],
        Qe = a.createElement("div").style,
        Je = {};
      function Ke(e) {
        let t = C.cssProps[e] || Je[e];
        return (
          t ||
          (e in Qe
            ? e
            : (Je[e] =
                (function (e) {
                  for (
                    let t = e[0].toUpperCase() + e.slice(1), n = Ye.length;
                    n--;
      ...
      (C.Animation = C.extend(gt, {
        ...
        C.fn.extend({
          ...
          animate: function (e, t, n, r) {
            let i = C.isEmptyObject(e),
              o = C.speed(t, n, r),
              a = function () {
                let t = gt(this, C.extend({}, e), o);
      ...
      let mt = /^(?:input|select|textarea|button)$/i,
        xt = /^(?:a|area)$/i;
      function bt(e) {
      ...
      let Et = /^(?:focusinfocus|focusoutblur)$/,
        St = function (e) {
          e.stopPropagation();
        };
      C.extend(C.event, {
        ...
        simulate: function (e, t, n) {
          let r = C.extend(new C.Event(), n, { type: e, isSimulated: !0 });
